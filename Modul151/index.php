...
<body>
  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
      ...
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <h1 class="font-weight-light">Empfehlung der Woche</h1>
        <p>Birds of Prey: The Emancipation of Harley Quinn</p>
        <a class="btn btn-primary" href="#">Mehr Infos</a>
      </div>
      <!-- /.col-md-4 -->
    </div>
    <!-- /.row -->
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; YUNG CINEMA</p>
    </div>
    <!-- /.container -->
  </footer>
